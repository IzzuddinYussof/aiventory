                    ...
                    children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    await _runWithLoading(() async {
                                      ...
                                      if ((_model.findBarcode?.succeeded ??
                                          true)) {
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                filled: true,
                                fillColor:
                                    (_model.quantityFocusNode?.hasFocus ??
                                            false)
                                        ? FlutterFlowTheme.of(context).accent1
                                        : FlutterFlowTheme.of(context)
                                            .secondaryBackground,
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor:
                              (_model.unitCostFocusNode?.hasFocus ?? false)
                                  ? FlutterFlowTheme.of(context).accent1
                                  : FlutterFlowTheme.of(context)
                                      .secondaryBackground,
                          contentPadding: EdgeInsetsDirectional.fromSTEB(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor:
                              (_model.totalCostFocusNode?.hasFocus ?? false)
                                  ? FlutterFlowTheme.of(context).accent1
                                  : FlutterFlowTheme.of(context)
                                      .secondaryBackground,
                          contentPadding: EdgeInsetsDirectional.fromSTEB(
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            filled: true,
                            fillColor:
                                (_model.remarkFocusNode?.hasFocus ?? false)
                                    ? FlutterFlowTheme.of(context).accent1
                                    : FlutterFlowTheme.of(context)
                                        .secondaryBackground,
                            contentPadding: EdgeInsetsDirectional.fromSTEB(
                          ...
                          child: Column(
                            ...
                            children: [
                              if (_model.uploadedImage == null ||
                                  (_model.uploadedImage?.bytes?.isEmpty ??
                                      true))
                                Container(
                                  decoration: BoxDecoration(
                                    color: FlutterFlowTheme.of(context)
                              ...
                              await _runWithLoading(() async {
                                await Future.wait([
                                  Future(() async {
                                    ...
                                    if ((_model
                                            .saveInventoryMovement?.succeeded ??
                                        true)) {
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(
                                        SnackBar(
                                  ...
                                  Future(() async {
                                    if (widget!.orderData != null) {
                                      _model.updateReceived = await OrderGroup
