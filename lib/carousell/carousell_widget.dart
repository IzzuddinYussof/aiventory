  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.carousellGetBack?.succeeded ?? true)) {
        FFAppState().carousellList = ((_model.carousellGetBack?.jsonBody ?? '')
                .toList()
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 16.0, 0.0, 8.0),
                            child: TextFormField(
                              controller: _model.serachInventoryTextController,
                              focusNode: _model.serachInventoryFocusNode,
                              onFieldSubmitted: (_) async {
                                _model.carousellGet =
                                    await CarousellGroup.carousellGetCall.call(
                                  name:
                                      _model.serachInventoryTextController.text,
                                );

                                if ((_model.carousellGet?.succeeded ?? true)) {
                                  FFAppState().carousellList = ((_model
                                                      .carousellGet?.jsonBody ??
                                                  '')
                                              .toList()
                                              .map<CarousellStruct?>(
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    ...
                                    onChanged: (val) async {
                                      ...
                                      _model.carousellGetChips =
                                          await CarousellGroup.carousellGetCall
                                              .call(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return GridView.builder(
                                        ...
                                        itemBuilder: (context, carousellIndex) {
                                          final carousellItem =
                                                ...
                                                onTap: () async {
                                                  context.pushNamed(
                                                    ...
                                                    queryParameters: {
                                                      'itemName':
                                                          serializeParam(
                                                        carousellItem.itemName,
                                                        ParamType.String,
                                                      ),
                                                      'branch': serializeParam(
                                                        carousellItem.branch,
                                                        ParamType.String,
                                                      ),
                                                      'image': serializeParam(
                                                        carousellItem.imageUrl,
                                                        ParamType.String,
                                                      ),
