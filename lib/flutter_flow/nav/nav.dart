...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            name: DashboardHQWidget.routeName,
            path: DashboardHQWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'dashboardHQ')
                : NavBarPage(
                    initialPage: 'dashboardHQ',
        ...
        FFRoute(
          ...
          path: StockInWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'StockIn')
              : StockInWidget(
                  orderData: params.getParam(
                    'orderData',
                    ParamType.DataStruct,
                    isList: false,
                    structBuilder: OrderListsStruct.fromSerializableMap,
                  ),
                ),
        ),
        FFRoute(
          name: CarousellWidget.routeName,
          path: CarousellWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Carousell')
              : CarousellWidget(
                  carousellId: params.getParam(
                    'carousellId',
                    ParamType.int,
                  ),
        ...
        FFRoute(
          name: TrackingOrderWidget.routeName,
          path: TrackingOrderWidget.routePath,
          builder: (context, params) => TrackingOrderWidget(
        ...
        FFRoute(
          name: EditInventoryWidget.routeName,
          path: EditInventoryWidget.routePath,
          builder: (context, params) => EditInventoryWidget(
            inventoryId: params.getParam(
              'inventoryId',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: UploadCarousellWidget.routeName,
          path: UploadCarousellWidget.routePath,
          builder: (context, params) => UploadCarousellWidget(
            inventoryId: params.getParam(
              'inventoryId',
              ParamType.int,
            ),
            ...
            searchCategory: params.getParam(
              'searchCategory',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: CarousellUpdateWidget.routeName,
          path: CarousellUpdateWidget.routePath,
