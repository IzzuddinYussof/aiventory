                        ...
                        Expanded(
                          child: FlutterFlowDropDown<int>(
                            ...
                            options: List<int>.from(
                              FFAppState().branchLists
                                  .map((e) => e.id)
                                  .toList(),
                            ),
                            optionLabels: FFAppState().branchLists
                                .map((e) => e.label)
                                .toList(),
                            onChanged: (val) async {
                              ...
                              safeSetState(() {});
                              FFAppState().branch = FFAppState().branchLists
                                  .where((e) => e.id == FFAppState().branchId)
                                  .toList()
                                  .firstOrNull!
                                  .label;
                              safeSetState(() {});
                              _model.branchDashboard = await DashboardGroup
                                  .dashboardHQCall
                                  .call(
                                    access: FFAppState().user.access,
                                    branchId: FFAppState().branchId.toString(),
                              ...
                              if ((_model.branchDashboard?.succeeded ?? true)) {
                                FFAppState().DashboardHQ =
                                    DashboardHQDataStruct.maybeFromMap(
                                      (_model.branchDashboard?.jsonBody ?? ''),
                                    )!;
                                safeSetState(() {});
                              } else {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Error Dashboard Branch'),
                                      content: Text(
                                        getJsonField(
                                          (_model.branchDashboard?.jsonBody ??
                                              ''),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(EditInventoryWidget.routeName);
                          },
                          text: 'Add Inventory',
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      formatNumber(
                                        FFAppState().DashboardHQ.totalInventory,
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed(
                            ...
                            queryParameters: {
                              'days': serializeParam('28', ParamType.String),
                            }.withoutNulls,
                          );
                        },
                        child: Container(
