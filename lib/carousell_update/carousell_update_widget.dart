...
import 'carousell_update_model.dart';
export 'carousell_update_model.dart';

class CarousellUpdateWidget extends StatefulWidget {
  const CarousellUpdateWidget({super.key});

  static String routeName = 'CarousellUpdate';
  static String routePath = '/carousellUpdate';

  @override
  State<CarousellUpdateWidget> createState() => _CarousellUpdateWidgetState();
}

class _CarousellUpdateWidgetState extends State<CarousellUpdateWidget> {
  late CarousellUpdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarousellUpdateModel());
                                    ...
                                    builder: (context) {
                                      ...
                                      return ListView.separated(
                                        ...
                                        separatorBuilder: (_, __) =>
                                            SizedBox(height: 1.0),
                                        itemBuilder: (context, buyListIndex) {
                                          final buyListItem =
                                              buyList[buyListIndex];
                                          return Container(
                                            width: double.infinity,
                                            decoration: BoxDecoration(
                                              color:
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          'Quantity: ${buyListItem.quantity.toString()} ${buyListItem.unit}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                          ...
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(
                                                                      8.0),
                                                          child: Image.asset(
                                                            'assets/images/Spin@1x-1.0s-200px-200px.gif',
                                                            width: 20.0,
                                                            height: 20.0,
                                                            fit: BoxFit.cover,
                                                          ),
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return ListView.separated(
                                        ...
                                        separatorBuilder: (_, __) =>
                                            SizedBox(height: 1.0),
                                        itemBuilder: (context, sellListIndex) {
                                          final sellListItem =
                                              sellList[sellListIndex];
                                          return Container(
                                            width: double.infinity,
                                            decoration: BoxDecoration(
                                              color:
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          'Quantity: ${sellListItem.quantity.toString()} ${sellListItem.unit}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
